...
export class Toolbar {
  ...
  _buildDom() {
    ...
    // Real <select>, not a static label: only "Autómata Finito" is
    // implemented today, but the other machine types are honestly disabled
    // options rather than a fake affordance with nothing behind it.
    ...
    for (const label of [
      ...
      "Expresión Regular — próximamente",
    ]) {
